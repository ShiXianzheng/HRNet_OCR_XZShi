...
from utils_origin import AverageMeter
from utils_origin import get_confusion_matrix
from utils import adjust_learning_rate

from utils_origin import get_world_size, get_rank
...
def train(config, epoch, num_epoch, epoch_iters, base_lr, num_iters,
    ...
    for i_iter, batch in enumerate(trainloader):
        ...
        preds = model(images)
        # print(np.asarray(preds.cpu()).shape)
        ...
        loss = criterion(preds, labels, config)
